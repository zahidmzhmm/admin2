    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a class="<?= $ac_class=='dropdown.php'?'active':'' ?><?= $ac_class=='dropdown_two.php'?'active':'' ?>" href="javascript:void(0);" >
                        <i class="fa fa-sitemap"></i>
                        <span>Dropdown</span>
                    </a>
                    <ul class="sub">
                        <li class="<?= $ac_class=='dropdown.php'?'active':'' ?>"><a href="<?= isset($back_asset)?$back_asset:'' ?>dropdown.php">Dropdown 01</a></li>
                        <li class="<?= $ac_class=='dropdown_two.php'?'active':'' ?>"><a href="<?= isset($back_asset)?$back_asset:'' ?>dropdown_two.php">Dropdown 02</a></li>
                    </ul>
                </li>
            </ul>
        </div>
